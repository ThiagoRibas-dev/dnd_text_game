...
11.1. Modify src/dndrpg/engine/scheduler.py: Completed.
11.2. Modify _exec_action in src/dndrpg/engine/rulehooks_runtime.py: Completed.
11.3. Link Scheduler and EffectsEngine: Completed.
